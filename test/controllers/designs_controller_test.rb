...
class DesignsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create design" do
    assert_difference('Design.count') do
      post designs_url, params: { design: { Design_name: @design.Design_name, Design_suitsize: @design.Design_suitsize, Design_suittype: @design.Design_suittype } }
    end
  ...
  test "should update design" do
    patch design_url(@design), params: { design: { Design_name: @design.Design_name, Design_suitsize: @design.Design_suitsize, Design_suittype: @design.Design_suittype } }
