...
class TypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create type" do
    assert_difference('Type.count') do
      post types_url, params: { type: { end_limit: @type.end_limit, start_limit: @type.start_limit, suit_type: @type.suit_type } }
    end
  ...
  test "should update type" do
    patch type_url(@type), params: { type: { end_limit: @type.end_limit, start_limit: @type.start_limit, suit_type: @type.suit_type } }
